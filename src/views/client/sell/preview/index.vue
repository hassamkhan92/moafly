<template>
  <div class="preview-container">
    ...
    <div class="footer">
      ...
      <!--  -->
      <WButton radius="4px" text="Publish listing" :disabled="isDisabled" v-loading="loading" width="161px" height="39px" @handleClick="handleNext()" class="next-btn"></WButton>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    handleNext() {
      this.$router.push('/person/selling-homes?houseId=' + this.form.houseId);
    },
    //去完成
    ...
    //预览
    handlerPreview() {
      this.$router.push('/preview-home?houseId=' + this.form.houseId);
    }
  }
};
</script>
