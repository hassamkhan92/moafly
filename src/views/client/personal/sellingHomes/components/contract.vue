 ...
 * @LastEditors: zulezhe
 * @LastEditTime: 2022-08-07 17:11:20
    ...
    <Popups :isShow="writePadIsShow" @handleClose="handleWritePadClose" width="900px" :modal="false">
      <div class="contract-container write-pad-container">
        ...
        <div class="contract-footer write-pad-footer">
          ...
          <WButton v-throttle text="Done" radius="4px" width="164px" height="48px" class="finished-btn" @handleClick="handleSave"></WButton>
        </div>
      </div>
    </Popups>
  </Popups>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      console.log('file===>', file, this.blob);
